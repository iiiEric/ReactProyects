...
export const OrderSchema = z.object({
    name: z.string().min(1, 'Nombre cliente es obligatorio'),
    total: z.number().min(1, 'Se han producido errores'),
...
export const SearchSchema = z.object({
    search: z.string()
            .trim()
            .min(1, {message: "Introduzca valores válidos para la búsqueda"})
})
